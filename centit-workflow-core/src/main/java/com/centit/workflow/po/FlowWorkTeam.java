...
/** full constructor */
    ...
    public FlowWorkTeam(String wfinstid, String usercode, String rolecode, String runToken, Date  authtime) {
        this.cid = new FlowWorkTeamId(wfinstid,  usercode,  rolecode, runToken);
        this.authTime= authtime;
    }
