            ...
            if (g("opttype").options[i].value == SVG.get(o).attr("opttype")) {
                ...
                if (SVG.get(o).attr("opttype") == "D") {//自动流程节点
                    ...
                    for (var l = 0; l < temp.length; l++) {
                        if (SVG.get(o).attr("optcode") == temp[l].value) {
                            $("#optcode2").append("<option  value='" + temp[l].value + "' selected='selected'>" + temp[l].text + "</option>");
                        }
                        else {
                            $("#optcode2").append("<option  value='" + temp[l].value + "' >" + temp[l].text + "</option>");
                        }
                    }
                }
