...
//		flowInst.setExpireTime(new Date(System.currentTimeMillis()+1000*60*60*24));
    ...
    public static void runAfterCreate(FlowInstance flowInst, NodeInstance nodeInst,
									  NodeInfo nodeInfo, String optUserCode, ServletContext application)
	...
	public static void runBeforeSubmit(FlowInstance flowInst, NodeInstance nodeInst,
									   NodeInfo nodeInfo, String optUserCode, ServletContext application) throws WorkflowException {
        if( nodeInfo.getOptBean()==null || "".equals(nodeInfo.getOptBean()))
            return;
	 ...
	 * @return
	 */
	public static boolean runAutoOperator(FlowInstance flowInst, NodeInstance nodeInst,
										  NodeInfo nodeInfo, String optUserCode, ServletContext application)
	                throws WorkflowException {
