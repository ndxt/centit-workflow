...
CREATE TABLE WF_OPTPAGE (
    ...
    OPT_NAME VARCHAR2(128) NOT NULL,
    OS_ID VARCHAR2(32),
    OWNER_UNIT VARCHAR2(32),
...
CREATE TABLE wf_node (
  ...
  OPT_PARAM varchar2(2048) DEFAULT NULL,
  SUB_FLOW_CODE varchar2(8) DEFAULT NULL ,
  NOTICE_TYPE varchar2(16) DEFAULT NULL ,
  NOTICE_MESSAGE varchar2(1000) DEFAULT NULL ,
  ROLE_TYPE varchar2(8) DEFAULT NULL ,
  ROLE_CODE varchar2(32) DEFAULT NULL,
